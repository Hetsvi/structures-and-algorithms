...
public class RuntimeComparison {
    ...
    public static int NUM_DIM = 5; // number of dimensions
    public static int TRAINING_SIZE = 90000; // the size of the training data
    public static int TEST_SIZE = 90000; // the size of the test data to find KNN
    public static int K = 10; // number of nearest neighbors to find
